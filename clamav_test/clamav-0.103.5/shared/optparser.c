...
const struct clam_option __clam_options[] = {
	...
	{"TrackingScanURLs", "tracking-scan-urls", 0, CLOPT_TYPE_BOOL, MATCH_BOOL, 1, NULL, 0, OPT_CLAMD | OPT_CLAMSCAN, "Scan URLs found in mails for tracking attempts using heuristics.", "yes" },
